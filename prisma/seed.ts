...
const sponsors = [
  ...
  },
  {
    ...
    type: SponsorType.SILVER,
    description:
      'Chaos е компания с български корени и днес е глобална сила в технологиите за 3D визуализация. Продуктите й за фотореалистични изображения се използват в архитектурата, киното, рекламата, продуктовия дизайн, автомобилната индустрия, търговията и навсякъде, където има нужда от висококачествена графика. Софтуерът V-Ray, създаден от екипа на Chaos в София, е отличен с престижните технологични награди “Оскар” и “Еми” за принос към визуалните ефекти в киното и телевизията. В края на март ще бъде отворено кандидатстването за академията Chaos Camp 2025 - безплатно онлайн обучение по алгоритми и структури от данни за C++ и въведение в компютърната графика и ray tracing. Ако се интересувате от технологии за визуализация и искате да се развивате в тази област, последвайте Chaos в социалните мрежи.',
    logo: 'chaos.png',
  ...
  },
  {
    ...
    description:
      'ПРОС България е лидер в разработката на високо технологични решения, които преобразуват дигитално бизнеса на авио- и B2B компании. Основани на динамично ценообразуване, продуктите на ПРОС дават възможност на компаниите да ценообразуват, конфигурират и продават своите продукти и услуги с бързина, прецизност и последователност във всички канали за продажба. Продуктите ни генерират повече от 200 милиона цени и 1,7 милиарда прогнози всеки ден за предприятия в над 30 индустрии по целия свят. Нашата мисия е да помогнем на компаниите и хората, които работят за тях, да бъдат лидери на своите пазари.',
    logo: 'pros.png',
